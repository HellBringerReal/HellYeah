...
from gotti import dispatcher, WHITELIST_USERS, TIGER_USERS
from gotti.modules.helper_funcs.chat_status import is_user_admin, user_admin, can_restrict, connection_status
from gotti.modules.log_channel import loggable
from gotti.modules.sql import antiflood_sql as sql
...
*Admin only:*
 - /setflood <Number/'no'/'off'>: enables or disables flood control
 Example: /setflood 10
