...
from gotti import dispatcher, LOGGER
from gotti.modules.disable import DisableAbleCommandHandler
from gotti.modules.helper_funcs.chat_status import user_admin
from gotti.modules.helper_funcs.extraction import extract_text
from gotti.modules.helper_funcs.filters import CustomFilters
from gotti.modules.helper_funcs.misc import build_keyboard
from gotti.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from gotti.modules.sql import cust_filters_sql as sql
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @tubhiaaja for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@tubhiaaja if you can't figure out why!")
