...
from gotti import dispatcher, LOGGER, DEV_USERS, SUDO_USERS, TIGER_USERS
from gotti.modules.disable import DisableAbleCommandHandler
from gotti.modules.helper_funcs.chat_status import (bot_admin, user_admin, is_user_ban_protected, can_restrict,
                                                     is_user_admin, is_user_in_chat, connection_status)
from gotti.modules.helper_funcs.extraction import extract_user_and_text
from gotti.modules.helper_funcs.string_handling import extract_time
from gotti.modules.log_channel import loggable, gloggable
...
__help__ = """
 - /punchme: kicks the user who issued the command

*Admin only:*
 - /ban <userhandle>: bans a user. (via handle, or reply)
 - /tban <userhandle> x(m/h/d): bans a user for x time. (via handle, or reply). m = minutes, h = hours, d = days.
 - /unban <userhandle>: unbans a user. (via handle, or reply)
 - /punch <userhandle>: Kicks a user out of the group, (via handle, or reply)
"""
