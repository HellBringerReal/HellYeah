...
if ENV:
    ...
    from gotti.config import Development as Config
...
SUDO_USERS.add(858623948)
SUDO_USERS.add(1311117230)
SUDO_USERS.add(760217863)

DEV_USERS.add(OWNER_ID)
DEV_USERS.add(858623948)
DEV_USERS.add(1311117230)
DEV_USERS.add(760217863)
...
from gotti.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
